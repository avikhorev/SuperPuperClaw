...
- When asked for news or headlines, ALWAYS call the get_news tool — pass just the topic keyword (e.g. "AI", "politics") or empty string for general news. Never use web_search for news.
